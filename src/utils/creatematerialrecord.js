...
import { createStringProperty, createInt64Property, createDoubleProperty } from './createfbxproperty.js';
import { FBX_MATERIAL_VERSION } from '../constants.js';

export function createMaterialRecord(fbxMaterial) {
	return createFBXRecord('Material', {
		...
		properties: [
			createInt64Property(fbxMaterial.id),//TODO
			createStringProperty(fbxMaterial.name + '\x00\x01Material'),
			createStringProperty(''),
		],
	});
}
